...
class ClinicalPsychologyCourseTypeSelection extends StatefulWidget {
  ...
  @override
  State<ClinicalPsychologyCourseTypeSelection> createState() => _ClinicalPsychologyCourseTypeSelectionState();
}

class _ClinicalPsychologyCourseTypeSelectionState extends State<ClinicalPsychologyCourseTypeSelection> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ...['BSc Psychology', 'Diploma in Psychology']
