...
class AudiologyCourseTypeSelection extends StatefulWidget {
  ...
  @override
  State<AudiologyCourseTypeSelection> createState() => _AudiologyCourseTypeSelectionState();
}

class _AudiologyCourseTypeSelectionState extends State<AudiologyCourseTypeSelection> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ...['BSc Audiology', 'Diploma in Audiology']
