...
class DiplomaDieteticsAcademicStatus extends StatefulWidget {
  const DiplomaDieteticsAcademicStatus({super.key});

  @override
  State<DiplomaDieteticsAcademicStatus> createState() => _DiplomaDieteticsAcademicStatusState();
}

class _DiplomaDieteticsAcademicStatusState extends State<DiplomaDieteticsAcademicStatus> {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          FormsMainHead(text: 'Diploma in Dietetics'),
          const Text(
          ...
          Row(
            ...
            children: [
              AcademicOption(
                ...
                onTap: () => Navigator.pushNamed(context, '/diploma_dietetics_diploma_ongoing'),
              ),
              AcademicOption(
                icon: Icons.school,
