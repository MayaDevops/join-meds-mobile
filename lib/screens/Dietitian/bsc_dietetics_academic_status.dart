...
class BScDieteticsAcademicStatus extends StatefulWidget {
  const BScDieteticsAcademicStatus({super.key});

  @override
  State<BScDieteticsAcademicStatus> createState() => _BScDieteticsAcademicStatusState();
}

class _BScDieteticsAcademicStatusState extends State<BScDieteticsAcademicStatus> {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          FormsMainHead(text: 'Bsc Dietetics'),
          const Text(
          ...
          Row(
            ...
            children: [
              AcademicOption(
                ...
                onTap: () => NavigationHelper.pushNamed(context, '/bsc_dietetics_degree_ongoing'),
              ),
              AcademicOption(
                icon: Icons.school,
