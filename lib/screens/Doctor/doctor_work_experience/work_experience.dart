...
class _WorkExperienceState extends State<WorkExperience> {
  final TextEditingController _orgOrHospitalNameController = TextEditingController();
  ...
  @override
  void dispose() {
    _orgOrHospitalNameController.dispose();
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormWidget(
                          controller: _orgOrHospitalNameController,
                          validator: (value) {
                            if (value!.isEmpty) {
