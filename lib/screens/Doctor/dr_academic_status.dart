...
class _AcademicOption extends StatelessWidget {
  ...
  const _AcademicOption({required this.icon, required this.label, required this.onTap});
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(label, style: const TextStyle(fontSize: 18, color: mainBlue, fontWeight: FontWeight.w500), textAlign: TextAlign.center),
          ],
        ),
      ),
    );
