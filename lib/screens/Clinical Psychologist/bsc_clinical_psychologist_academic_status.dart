...
class BScPsychologyStatus extends StatefulWidget {
  const BScPsychologyStatus({super.key});

  @override
  State<BScPsychologyStatus> createState() => _BScPsychologyStatusState();
}

class _BScPsychologyStatusState extends State<BScPsychologyStatus> {
        ...
        return StatefulBuilder(
          builder: (context, setStateSheet) => Column(
            ...
            children: [
              ...
              const SizedBox(height: 30),
              SafeArea(
                minimum: const EdgeInsets.all(16), // You can adjust this
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          FormsMainHead(text: 'Bsc Psychology'),
          const Text(
          ...
          Row(
            ...
            children: [
              AcademicOption(
                ...
                onTap: () => NavigationHelper.pushNamed(context, '/bsc_psychology_degree_ongoing'),
              ),
              AcademicOption(
                icon: Icons.school,
    ...
    return StatefulBuilder(
      builder: (context, setState) => Column(
        ...
        children: [
          ...
          SafeArea(
            minimum: const EdgeInsets.all(16), // Adjust spacing as needed
            child: ElevatedButton(
              onPressed: () {
