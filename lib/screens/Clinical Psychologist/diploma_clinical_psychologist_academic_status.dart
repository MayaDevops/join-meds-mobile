...
class DiplomaPsychologyAcademicStatus extends StatefulWidget {
  const DiplomaPsychologyAcademicStatus({super.key});

  @override
  State<DiplomaPsychologyAcademicStatus> createState() => _DiplomaPsychologyAcademicStatusState();
}

class _DiplomaPsychologyAcademicStatusState extends State<DiplomaPsychologyAcademicStatus> {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          FormsMainHead(text: 'Diploma in Psychology'),
          const Text(
          ...
          Row(
            ...
            children: [
              AcademicOption(
                ...
                onTap: () => NavigationHelper.pushNamed(context, '/diploma_psychology_diploma_ongoing'),
              ),
              AcademicOption(
                icon: Icons.school,
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SafeArea(
              minimum: const EdgeInsets.all(16), // Optional: adds padding around the button
