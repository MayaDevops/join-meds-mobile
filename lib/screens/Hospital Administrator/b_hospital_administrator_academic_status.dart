...
class BHAdministratorAcademicStatus extends StatefulWidget {
  const BHAdministratorAcademicStatus({super.key});

  @override
  State<BHAdministratorAcademicStatus> createState() => _BHAdministratorAcademicStatusState();
}

class _BHAdministratorAcademicStatusState extends State<BHAdministratorAcademicStatus> {
        ...
        return StatefulBuilder(
          builder: (context, setStateSheet) => Column(
            ...
            children: [
              ...
              const SizedBox(height: 30),
              SafeArea(
                minimum: const EdgeInsets.all(16), // Optional padding for aesthetics
          ...
          Row(
            ...
            children: [
              AcademicOption(
                ...
                onTap: () => NavigationHelper.pushNamed(context, '/bha_degree_ongoing'),
              ),
              AcademicOption(
                icon: Icons.school,
    ...
    return StatefulBuilder(
      builder: (context, setState) => Column(
        ...
        children: [
          ...
          SafeArea(
            minimum: const EdgeInsets.all(16), // Adds padding from edges
            child: ElevatedButton(
              onPressed: () {
