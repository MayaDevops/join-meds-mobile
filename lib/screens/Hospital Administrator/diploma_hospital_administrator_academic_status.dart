...
class DiplomaHospitalAdministratorAcademicStatus extends StatefulWidget {
  const DiplomaHospitalAdministratorAcademicStatus({super.key});

  @override
  State<DiplomaHospitalAdministratorAcademicStatus> createState() => _DiplomaHospitalAdministratorAcademicStatusState();
}

class _DiplomaHospitalAdministratorAcademicStatusState extends State<DiplomaHospitalAdministratorAcademicStatus> {
          ...
          Row(
            ...
            children: [
              AcademicOption(
                ...
                onTap: () => NavigationHelper.pushNamed(context, '/diploma_hospital_administrator_diploma_ongoing'),
              ),
              AcademicOption(
                icon: Icons.school,
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SafeArea(
              minimum: const EdgeInsets.all(16), // Ensures padding from screen edges
              child: SizedBox(
                width: double.infinity, // Makes button full-width if needed
