...
class DiplomaPhysiotherapyAcademicStatus extends StatefulWidget {
  ...
  @override
  State<DiplomaPhysiotherapyAcademicStatus> createState() =>
      _DiplomaPhysiotherapyAcademicStatusState();
}

class _DiplomaPhysiotherapyAcademicStatusState
    extends State<DiplomaPhysiotherapyAcademicStatus> {
          ...
          Row(
            ...
            children: [
              AcademicOption(
                ...
                onTap: () =>
                    NavigationHelper.pushNamed(context, '/dpt_diploma_ongoing'),
              ),
              AcademicOption(
                icon: Icons.school,
