...
class BPharmDegreeOngoing extends StatefulWidget {
  const BPharmDegreeOngoing({super.key});

  @override
  State<BPharmDegreeOngoing> createState() => _BPharmDegreeOngoingState();
}

class _BPharmDegreeOngoingState extends State<BPharmDegreeOngoing> {
  String? academicYear;
  @override
