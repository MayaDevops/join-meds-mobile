...
class PharmDAcademicStatus extends StatefulWidget {
  const PharmDAcademicStatus({super.key});

  @override
  State<PharmDAcademicStatus> createState() => _PharmDAcademicStatusState();
}

class _PharmDAcademicStatusState extends State<PharmDAcademicStatus> {
          ...
          Row(
            ...
            children: [
              AcademicOption(
                ...
                onTap: () =>
                    NavigationHelper.pushNamed(context, '/pharm_d_degree_ongoing'),
              ),
              AcademicOption(
                icon: Icons.school,
