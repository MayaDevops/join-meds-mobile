...
class PharmDDegreeOngoing extends StatefulWidget {
  const PharmDDegreeOngoing({super.key});

  @override
  State<PharmDDegreeOngoing> createState() => _PharmDDegreeOngoingState();
}

class _PharmDDegreeOngoingState extends State<PharmDDegreeOngoing> {
  String? academicYear;
  @override
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text('6th Year',style: radioTextStyle,),
                  ],
                ),
