...
class DPharmDiplomaAcademicStatus extends StatefulWidget {
  const DPharmDiplomaAcademicStatus({super.key});

  @override
  State<DPharmDiplomaAcademicStatus> createState() => _DPharmDiplomaAcademicStatusState();
}

class _DPharmDiplomaAcademicStatusState extends State<DPharmDiplomaAcademicStatus> {
          ...
          Row(
            ...
            children: [
              AcademicOption(
                ...
                onTap: () => NavigationHelper.pushNamed(context, '/d_pharm_degree_ongoing'),
              ),
              AcademicOption(
                icon: Icons.school,
