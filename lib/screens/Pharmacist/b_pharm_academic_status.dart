...
class BPharmaAcademicStatus extends StatefulWidget {
  const BPharmaAcademicStatus({super.key});

  @override
  State<BPharmaAcademicStatus> createState() => _BPharmaAcademicStatusState();
}

class _BPharmaAcademicStatusState extends State<BPharmaAcademicStatus> {
          ...
          Row(
            ...
            children: [
              AcademicOption(
                ...
                onTap: () => NavigationHelper.pushNamed(context, '/b-pharm_degree_ongoing'),
              ),
              AcademicOption(
                icon: Icons.school,
