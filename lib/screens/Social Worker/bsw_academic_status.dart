...
class BSWAcademicStatus extends StatefulWidget {
  const BSWAcademicStatus({super.key});

  @override
  State<BSWAcademicStatus> createState() => _BSWAcademicStatusState();
}

class _BSWAcademicStatusState extends State<BSWAcademicStatus> {
          ...
          Row(
            ...
            children: [
              AcademicOption(
                ...
                onTap: () =>
                    NavigationHelper.pushNamed(context, '/bsw_degree_ongoing'),
              ),
              AcademicOption(
                icon: Icons.school,
    ...
    return StatefulBuilder(
      builder: (context, setState) => Column(
        ...
        children: [
          ...
          SafeArea(
            minimum: const EdgeInsets.all(16), // adds breathing room
            child: ElevatedButton(
              onPressed: () {
