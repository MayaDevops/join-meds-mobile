...
class DiplomaSocialWorkAcademicStatus extends StatefulWidget {
  ...
  @override
  State<DiplomaSocialWorkAcademicStatus> createState() => _DiplomaSocialWorkAcademicStatusState();
}

class _DiplomaSocialWorkAcademicStatusState extends State<DiplomaSocialWorkAcademicStatus> {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          FormsMainHead(text: 'Diploma in Social Work'),
          const Text(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SafeArea(
              minimum: const EdgeInsets.all(16), // Optional: Adds space on all sides
