...
class BScAudiologyAcademicStatus extends StatefulWidget {
  const BScAudiologyAcademicStatus({super.key});

  @override
  State<BScAudiologyAcademicStatus> createState() =>
      _BScAudiologyAcademicStatusState();
}

class _BScAudiologyAcademicStatusState
    extends State<BScAudiologyAcademicStatus> {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          FormsMainHead(text: 'Bsc Audiology'),
          const Text(
            ...
            children: [
              AcademicOption(
                ...
                onTap: () => Navigator.pushNamed(
                    context, '/bsc_audiology_degree_ongoing'),
              ),
              AcademicOption(
                icon: Icons.school,
