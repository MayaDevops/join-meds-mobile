...
class DMLTAcademicStatus extends StatefulWidget {
  const DMLTAcademicStatus({super.key});

  @override
  State<DMLTAcademicStatus> createState() => _DMLTAcademicStatusState();
}

class _DMLTAcademicStatusState extends State<DMLTAcademicStatus> {
          ...
          Row(
            ...
            children: [
              AcademicOption(
                ...
                onTap: () =>
                    NavigationHelper.pushNamed(context, '/dmlt_diploma_ongoing'),
              ),
              AcademicOption(
                icon: Icons.school,
