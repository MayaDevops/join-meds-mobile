...
class DMLTDiplomaOngoing extends StatefulWidget {
  const DMLTDiplomaOngoing({super.key});

  @override
  State<DMLTDiplomaOngoing> createState() => _DMLTDiplomaOngoingState();
}

class _DMLTDiplomaOngoingState extends State<DMLTDiplomaOngoing> {
  String? academicYear;
  @override
